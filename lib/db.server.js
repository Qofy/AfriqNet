...
try {
  ...
  if (movieCount === 0) {
    ...
    const movies = [
      ['m1', 'All The Devils Are There', 'Movie', '/images/movies/All-The-Devils-Are-Here-link2.webp', '/images/movies/All_the_Devils_Are_Here_poster.jpg', 8.5, '2024-01-15', "A 'bottle thriller' centered on a post-heist getaway where the criminals' paranoia creates a 'submarine hell' atmosphere.", '878,53,28', 142, 'Reality is just the beginning', '', '/trailer/All-the-devils-are-there.mp4'],
