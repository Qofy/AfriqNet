...
try {
  ...
  if (movieCount === 0) {
    ...
    const movies = [
      ['m1', 'All The Devils Are There', 'Movie', '/images/movies/All-The-Devils-Are-Here-link2.webp', '/images/movies/All_the_Devils_Are_Here_poster.jpg', 8.5, '2024-01-15', "A 'bottle thriller' centered on a post-heist getaway where the criminals' paranoia creates a 'submarine hell' atmosphere.", '878,53,28', 142, 'Reality is just the beginning', '/trailer/All-the-devils-are-there.mp4', '/trailer/All-the-devils-are-there.mp4'],
      ['m2', 'The Last Horizon', 'Movie', '/images/movies/gl-2-link2.jpg', '/images/movies/greenland-2.jpg', 7.8, '2023-11-20', 'A gripping tale of survival as humanity\'s last spaceship searches for a new home among the stars.', '878,12,18', 156, 'Our journey ends where hope begins', '/trailer/Under-the-stars.mp4', '/trailer/Under-the-stars.mp4'],
      ['m3', 'Greeland 2', 'Movie', '/images/movies/greenland-2.jpg', '/images/movies/gl-2-link2.jpg', 8.2, '2024-02-10', 'An action-packed survival thriller as humanity faces extinction from natural disasters.', '28,53,80', 128, 'Trust no one', '/trailer/Greeland-2.mp4', '/trailer/Greeland-2.mp4'],
      ...
      ['m5', 'Chief of War', 'Movie', '/images/movies/chief-of-war.jpg', '/images/movies/chief-f-w-link2.jpg', 7.2, '2023-08-15', 'An epic tale of power, conquest and the birth of the Hawaiian Kingdom.', '35,10751,18', 105, 'A kingdom forged in blood', '/trailer/chief-of-war.mp4', '/trailer/chief-of-war.mp4'],
      ['m6', 'Running Man', 'Movie', '/images/movies/the-running-man.jpg', '/images/movies/the-r-m-link2.jpg', 8.7, '2023-10-31', 'A dystopian action thriller where contestants fight for survival in a deadly game show.', '14,18,10751,28', 118, 'Run or die', '/trailer/runningMan.mp4', '/trailer/runningMan.mp4'],
      ['m7', 'The Chief and I', 'Movie', 'https://i.ytimg.com/vi/QItezpzarLQ/maxresdefault.jpg', 'https://i.ytimg.com/vi/QItezpzarLQ/maxresdefault.jpg', 7.7, '2024-03-05', 'Follows an undercover restaurant worker trying to expose hidden truths within the business while balancing family expectations and a developing romance.', '80,53,9648', 130, 'The greatest heist ever told', '/movies/THE_CHEF_AND_I.mp4', '/trailer/chief-of-war.mp4']
    ];
    ...
    const musicInsert = db.prepare(`
      INSERT INTO music_videos (id, title, artist, type, poster, backdrop, rating, release_date, overview, genre_ids, duration, views, stream)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `);

    const musicVideos = [
      ['mv1', 'Oil On My Head', 'Black Sherif', 'Music Video', '/images/music/oil-on-my-head.jpg', '/images/music/o-n-m-h-link2.jpg', 9.2, '2024-03-15', 'An energetic Afrobeats anthem celebrating the vibrant nightlife of Ghana. Stunning visuals showcase the city\'s culture and energy.', '1,9', '3:45', '15.2M', '/music/oil-on-my-head.mp4'],
      ['mv2', 'Stir Up', 'Sarkodie ft. Bob Marley', 'Music Video', '/images/music/stir-up.jpg', '/images/music/s-u-link2.jpg', 9.5, '2024-02-20', 'A powerful fusion of traditional African sounds and modern production. The video features breathtaking cinematography across various African landscapes.', '1,8', '4:12', '22.8M', '/music/stir-up.mp4'],
      ['mv3', 'Ten Toes', 'King Promise ft. fireboy', 'Music Video', '/images/music/ten-toes.jpg', '/images/music/t-t-link2.jpg', 8.8, '2024-01-10', 'A celebration of Ghanaian culture with infectious beats and colorful visuals. The collaboration brings together two of Ghana\'s finest artists.', '2,5', '3:28', '18.5M', '/music/ten-toes(king-promise).mp4'],
      ['mv4', 'Therapy', 'Stone Bwoy', 'Music Video', '/images/music/therapy.png', '/images/music/tra-link2.jpg', 9.0, '2023-12-28', 'The kings of Amapiano deliver another hit with hypnotic rhythms and smooth production. Shot in the heart of Johannesburg\'s music scene.', '6', '4:35', '25.1M', '/music/therapy(stone-bwoy).mp4'],
      ['mv5', 'Soulful Journey', 'Asa', 'Music Video', 'https://images.unsplash.com/photo-1458560871784-56d23406c091?w=500&q=80', 'https://images.unsplash.com/photo-1458560871784-56d23406c091?w=1920&q=80', 8.7, '2024-02-05', 'An intimate and soulful performance that showcases Asa\'s incredible vocal range and emotional depth. Minimalist visuals that let the music speak.', '3,10', '3:52', '12.3M', '/trailer/WAR-MACHINE-Official-Trailer-Netflix.mp4'],
      ['mv6', 'Blessed', 'Nathaniel Bassey', 'Music Video', 'https://images.unsplash.com/photo-1415886541506-6efc5e4b1786?w=500&q=80', 'https://images.unsplash.com/photo-1415886541506-6efc5e4b1786?w=1920&q=80', 9.3, '2024-01-01', 'An uplifting gospel anthem with powerful vocals and inspiring visuals. Perfect for worship and meditation.', '4', '5:20', '30.5M', '/trailer/All-the-devils-are-there.mp4'],
      ['mv7', 'Island Rhythm', 'Stonebwoy', 'Music Video', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=500&q=80', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1920&q=80', 8.9, '2023-11-15', 'A reggae-dancehall fusion that brings Caribbean vibes to West Africa. Shot on beautiful tropical beaches with stunning sunset scenes.', '7,8', '3:35', '16.7M', '/trailer/runningMan.mp4'],
      ['mv8', 'Street Symphony', 'Olamide', 'Music Video', 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=500&q=80', 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=1920&q=80', 8.6, '2024-03-01', 'Raw and authentic hip-hop from the streets of Lagos. Olamide delivers hard-hitting bars over a trap-influenced beat.', '2', '3:15', '20.2M', '/trailer/chief-of-war.mp4'],
...
export function getAllMusicVideos() {
  const stmt = db.prepare(`
    SELECT id, title, artist, type, poster, backdrop, rating, release_date, 
           overview, genre_ids, duration, views, stream FROM music_videos ORDER BY rating DESC
  `);
...
export function getMusicVideoById(id) {
  const stmt = db.prepare(`
    SELECT id, title, artist, type, poster, backdrop, rating, release_date, 
           overview, genre_ids, duration, views, stream FROM music_videos WHERE id = ?
  `);
...
// Helper to access the raw database instance from other modules
